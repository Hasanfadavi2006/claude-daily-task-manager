...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle s) {
        ...
        findViewById(R.id.btnSendOtp).setOnClickListener(v -> {
            ...
            new Thread(() -> {
                ...
                String msg = r.optBoolean("ok",false) ? "کد OTP ارسال شد ✅" : "خطا: " + r.optString("error");
        ...
        findViewById(R.id.btnVerifyOtp).setOnClickListener(v -> {
            ...
            String phone = prefs().getString("rubika_phone","");
            new Thread(() -> {
                JSONObject body = obj("phone", phone); try { body.put("otp", otp); } catch(Exception ig){}
    ...
    private void appendLog(String line) {
        ...
        tvLog.setText(line + "\n" + (cur.length() > 3000 ? cur.substring(0, 3000) : cur));
    }

    private SharedPreferences prefs() {
        return getSharedPreferences("dailytask", MODE_PRIVATE);
    }
